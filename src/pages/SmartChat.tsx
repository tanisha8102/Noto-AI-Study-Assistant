...
<div className="flex flex-col sm:flex-row gap-2">
  <input
    className="flex-1 text-sm sm:text-base p-2 sm:p-4 border border-gray-300 dark:border-gray-600 rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500 dark:bg-gray-800/80 dark:text-gray-100 transition-all shadow-inner backdrop-blur-sm w-full"
    value={input}
  ...
  <button
    onClick={handleAsk}
    className="w-full sm:w-auto text-sm sm:text-base px-4 sm:px-6 py-2 sm:py-3 rounded-full bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-500 hover:from-indigo-700 hover:via-purple-700 hover:to-pink-600 text-white font-semibold shadow-lg transition-all duration-300 disabled:opacity-50"
    disabled={loading}
  >
    {loading ? "..." : "Send"}
  </button>
